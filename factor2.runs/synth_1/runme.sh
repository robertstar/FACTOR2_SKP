...
HD_PWD='/home/master/FPGA_proj/FACTOR2/factor2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log factor2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source factor2.tcl
